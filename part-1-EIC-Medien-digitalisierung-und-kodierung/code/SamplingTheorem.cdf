...
NotebookDataLength[     81129,       1666]
NotebookOptionsPosition[     53914,       1080]
NotebookOutlinePosition[     80158,       1641]
CellTagsIndexPosition[     80047,       1635]
WindowTitle->Sampling Theorem
WindowFrame->Normal*)
...
Cell["Sampling Theorem", "DemoTitle"],

Cell[BoxData[
 TagBox[
  StyleBox[
   DynamicModuleBox[{$CellContext`f$$ = 1000, $CellContext`fs$$ = 16000, 
    Typeset`show$$ = True, Typeset`bookmarkList$$ = {}, 
    Typeset`bookmarkMode$$ = "Menu", Typeset`animator$$, Typeset`animvar$$ = 
    1, Typeset`name$$ = "\"untitled\"", Typeset`specs$$ = {{
      Hold[
       Style["frequency", Bold]], Manipulate`Dump`ThisIsNotAControl}, {{
       Hold[$CellContext`f$$], 1000, "f [Hz]"}, 1000, 10000, 1}, {
      Hold[
       Style["sampling rate", Bold]], Manipulate`Dump`ThisIsNotAControl}, {{
       Hold[$CellContext`fs$$], 16000, 
       "\!\(\*SubscriptBox[\(f\), \(s\)]\)"}, {
      8000 -> "8 kHz", 16000 -> "16 kHz", 48000 -> "48 kHz"}}}, 
    Typeset`size$$ = {380., {190., 195.}}, Typeset`update$$ = 0, 
    Typeset`initDone$$, Typeset`skipInitDone$$ = 
    True, $CellContext`f$60979$$ = 0, $CellContext`fs$60980$$ = False}, 
    DynamicBox[Manipulate`ManipulateBoxes[
     1, StandardForm, 
      "Variables" :> {$CellContext`f$$ = 1000, $CellContext`fs$$ = 16000}, 
      "ControllerVariables" :> {
        Hold[$CellContext`f$$, $CellContext`f$60979$$, 0], 
        Hold[$CellContext`fs$$, $CellContext`fs$60980$$, False]}, 
      "OtherVariables" :> {
       Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
        ...
        Typeset`specs$$, Typeset`size$$, Typeset`update$$, Typeset`initDone$$,
         ...
         Show[
          Plot[
           Sin[
           2 Pi $CellContext`f$$ $CellContext`t], {$CellContext`t, 0, 0.001}, 
           PlotRange -> {-1.1, 1.1}, PlotStyle -> {{
              RGBColor[0.25, 0.43, 0.82]}}], 
          ListPlot[
           Table[{$CellContext`t, 
             Sin[2 Pi $CellContext`f$$ $CellContext`t]}, {$CellContext`t, 0, 
             0.001, 1/$CellContext`fs$$}], PlotMarkers -> {Automatic}, 
           Filling -> Axis, FillingStyle -> RGBColor[0.25, 0.43, 0.82]], 
          If[$CellContext`f$$ > $CellContext`fs$$/2, 
           Plot[
            Sin[
            2 Pi ($CellContext`f$$ - $CellContext`fs$$) $CellContext`t], \
{$CellContext`t, 0, 0.001}, PlotRange -> {-1.1, 1.1}, PlotStyle -> {
              If[$CellContext`f$$ > $CellContext`fs$$, 
               RGBColor[0.6, 0.73, 0.36], 
               RGBColor[0.9, 0.42, 0.17]], 
              Dashing[{0.01, 0.01}]}], 
           Graphics[]], Frame -> True, FrameLabel -> {{None, None}, {
             TraditionalForm[
              Text[
               $CellContext`t[$CellContext`s]]], 
             Row[{$CellContext`sin, "(", 2 Pi, 
               Style["f ", Italic], $CellContext`t, ")"}]}}, 
          FrameTicks -> {Automatic, None}, AspectRatio -> 0.35, 
          ImageSize -> {350, 175}, ImagePadding -> {{20, 20}, {35, 35}}], 
         Graphics[{{
            RGBColor[0.25, 0.43, 0.82], 
            Arrowheads[Large], 
            Arrow[{{$CellContext`f$$, 0}, {$CellContext`f$$, 1}}], 
            Arrow[{{-$CellContext`f$$, 0}, {-$CellContext`f$$, 1}}]}, {
            RGBColor[0.9, 0.42, 0.17], 
            Arrowheads[Large], 
            
            Arrow[{{$CellContext`f$$ + $CellContext`fs$$, 
               0}, {$CellContext`f$$ + $CellContext`fs$$, 1}}], 
            ...
            Arrow[{{$CellContext`f$$ + 2 $CellContext`fs$$, 
               0}, {$CellContext`f$$ + 2 $CellContext`fs$$, 1}}], 
            
            Arrow[{{-$CellContext`f$$ + 2 $CellContext`fs$$, 
               0}, {-$CellContext`f$$ + 2 $CellContext`fs$$, 1}}]}, {Gray, 
            Arrowheads[Large], 
            ...
            Arrow[{{-$CellContext`f$$ - 2 $CellContext`fs$$, 
               0}, {-$CellContext`f$$ - 2 $CellContext`fs$$, 1}}]}, {Dashed, 
            Line[{{-$CellContext`fs$$, 0}, {-$CellContext`fs$$, 1}}], 
            Line[{{$CellContext`fs$$, 0}, {$CellContext`fs$$, 1}}]}, 
           Text[
           "\!\(\*SubscriptBox[\(f\), \(s\)]\)", {$CellContext`fs$$, 1.1}], 
           Text[
           "-\!\(\*SubscriptBox[\(f\), \(s\)]\)", {-$CellContext`fs$$, 1.1}]},
           Frame -> True, Axes -> True, 
          PlotRange -> {{-$CellContext`fs$$ - 2000, $CellContext`fs$$ + 
             2000}, {0, 1.2}}, FrameLabel -> {{None, None}, {
             Row[{
               Style["f", Italic], " (Hz)"}], 
             Row[{
               Style["S", Italic], "(", 
               Style["f", Italic], ")"}]}}, FrameTicks -> {Automatic, None}, 
          AspectRatio -> 0.35, PlotRangeClipping -> True, 
          ImageSize -> {350, 175}, ImagePadding -> {{20, 20}, {35, 35}}]}], 
      "Specifications" :> {
        Style[
        "frequency", Bold], {{$CellContext`f$$, 1000, "f [Hz]"}, 1000, 10000, 
         1, Appearance -> "Labeled", ImageSize -> Small}, Delimiter, 
        Style[
        "sampling rate", 
         Bold], {{$CellContext`fs$$, 16000, 
          "\!\(\*SubscriptBox[\(f\), \(s\)]\)"}, {
         8000 -> "8 kHz", 16000 -> "16 kHz", 48000 -> "48 kHz"}}}, 
      "Options" :> {ControlPlacement -> Left}, 
      "DefaultOptions" :> {ControllerLinking -> True}],
     ImageSizeCache->{608., {219., 224.}},
...
Cell[TextData[{
 ...
 Cell[BoxData[
  FormBox[
   RowBox[{"\[PlusMinus]", "f"}], TraditionalForm]], "InlineMath"],
 ", repeated periodically at integer multiples of the sampling rate ",
 Cell[BoxData[
  FormBox[
   SubscriptBox["f", "s"], TraditionalForm]], "InlineMath"],
 ". "
}], "ManipulateCaption",
 CellID->139043981],
   ...
   RowBox[{
    ...
    FormBox[
     RowBox[{
      SubscriptBox["f", "s"], "/", "2"}],
     TraditionalForm]}], TraditionalForm]], "InlineMath"],
 ", aliasing occurs, because the replicated spectra begin to overlap. In the \
range ",
 Cell[BoxData[
  FormBox[
   RowBox[{"0", "\[LessEqual]", 
   ...
   RowBox[{"|", 
    RowBox[{
     ...
     FormBox[
      SubscriptBox["f", "s"],
      TraditionalForm]}], "|"}], TraditionalForm]], "InlineMath"],
 ". In the upper figure the sine wave with the corresponding frequency and \
color appears."
}], "ManipulateCaption",
 CellID->463289672],
...
Cell[TextData[{
 ...
 Cell[BoxData[
  FormBox[
   RowBox[{
    SubscriptBox["f", "s"], "=", 
    RowBox[{"8", " ", "kHz"}]}], TraditionalForm]], "InlineMath"],
 " and ",
 Cell[BoxData[
  FormBox[
   RowBox[{"f", ">", 
    RowBox[{"6", " ", "kHz"}]}], TraditionalForm]], "InlineMath"],
 ", additional lines at ",
 Cell[BoxData[
  FormBox[
   RowBox[{
...
Cell[TextData[{
 ButtonBox["Aliasing",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://mathworld.wolfram.com/Aliasing.html"], None}],
 " (",
 ButtonBox["Wolfram",
  BaseStyle->"SiteLink",
  ButtonData->{
...
Cell[TextData[{
 ButtonBox["Aliasing in Time Series Analysis",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/AliasingInTimeSeriesAnalysis/"], 
    None}],
 " (",
...
Cell[TextData[{
 ButtonBox["Sampling Theorem",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://mathworld.wolfram.com/SamplingTheorem.html"], None}],
 " (",
 ButtonBox["Wolfram",
  BaseStyle->"SiteLink",
  ButtonData->{
...
SamplingTheorem&version=0005"], None},
  ButtonNote->
   "http://demonstrations.wolfram.com/SamplingTheorem/SamplingTheorem-source.\
...
Cell[TextData[{
 ...
 ButtonBox["Sampling Theorem",
  BaseStyle->"SiteLink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/SamplingTheorem/"], None},
  ButtonNote->"http://demonstrations.wolfram.com/SamplingTheorem/"],
 "\"",
 " from ",
 ...
 ButtonBox["http://demonstrations.wolfram.com/SamplingTheorem/",
  BaseStyle->"SiteLink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/SamplingTheorem/"], None},
  ButtonNote->"http://demonstrations.wolfram.com/SamplingTheorem/"]
...
Cell[TextData[{
 "Contributed by: ",
 ButtonBox["Carsten Roppel",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/author.html?author=Carsten+Roppel"]\
, None},
  ButtonNote->
   "http://demonstrations.wolfram.com/author.html?author=Carsten+Roppel"]
}], "Author",
...
CellTagsIndex->{
 "ControlSuggestions"->{
  Cell[43914, 824, 258, 7, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"],
  Cell[44175, 833, 1372, 31, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"]},
 "Copyright"->{
  Cell[53092, 1055, 818, 23, 70, "Text",
   CellTags->"Copyright"]}
 }
*)
(*CellTagsIndex
CellTagsIndex->{
 {"ControlSuggestions", 79760, 1624},
 {"Copyright", 79955, 1629}
 }
*)
(*NotebookFileOutline
Notebook[{
Cell[580, 21, 34328, 567, 70, "DemonstrationHeader"],
Cell[34911, 590, 37, 0, 70, "DemoTitle"],
Cell[34951, 592, 6180, 130, 70, "Output",
 CellID->441025358],
Cell[41134, 724, 675, 19, 70, "ManipulateCaption",
 CellID->139043981],
Cell[41812, 745, 1402, 48, 70, "ManipulateCaption",
 CellID->463289672],
Cell[43217, 795, 694, 27, 70, "ManipulateCaption",
 CellID->245609513],
Cell[43914, 824, 258, 7, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[44175, 833, 1372, 31, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[45550, 866, 44, 0, 70, "RelatedLinksSection"],
Cell[45597, 868, 556, 20, 70, "RelatedLinks",
 CellID->712479760],
Cell[46156, 890, 437, 14, 70, "RelatedLinks",
 CellID->22273998],
Cell[46596, 906, 571, 20, 70, "RelatedLinks",
 CellID->146570398],
Cell[47170, 928, 4784, 89, 70, "DemoSourceNotebookSection",
 CellGroupingRules->{"SectionGrouping", 25}],
Cell[51957, 1019, 45, 0, 70, "CitationSection"],
Cell[52005, 1021, 754, 20, 70, "Citations"],
Cell[52762, 1043, 327, 10, 70, "Author"],
Cell[53092, 1055, 818, 23, 70, "Text",
 CellTags->"Copyright"]
}
]
...
(* NotebookSignature lTENg6d5LJ5s1wmUeSvf9yd# *)
