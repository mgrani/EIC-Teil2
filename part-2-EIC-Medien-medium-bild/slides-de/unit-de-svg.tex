...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\renewcommand{\textbufferB}{SVG - Scalable Vector Graphics}
\begin{bsslide}
  \bspar1
  \begin{center}
 \vspace{0.4\textheight}
  ...
  \begin{bsslide}[\textbufferB]
    ...
    \begin{minipage}[t]{0.40\linewidth}
      ...
      \begin{itemize}
        ...
        \item Filter-Effekte, Objektvorlagen
      \end{itemize}
      \bspar1
